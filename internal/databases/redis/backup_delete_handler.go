...
func HandleBackupDelete(ctx context.Context, folder storage.Folder, backupName string, dryRun bool) error {
	...
	if err := internal.DeleteBackups(ctx, internalFolder, []string{backup.Name()}); err != nil {
		return err
	}
