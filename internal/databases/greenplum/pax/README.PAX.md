...
It combines row-store and column-store properties: data is grouped
...
[ORC](https://orc.apache.org/) that reuses only the protobuf schema. A second variant, **PORC_VEC**, is
used by the vectorized executor; layout is the same, only the in-stream datum encoding differs.
...
(`paxc_wrappers.cc:102`[(src)](https://github.com/apache/cloudberry/blob/2.1.0-incubating/contrib/pax_storage/src/cpp/comm/paxc_wrappers.cc#L102)).
...
Writer open flags (`file_system.h:42-45`[(src)](https://github.com/apache/cloudberry/blob/2.1.0-incubating/contrib/pax_storage/src/cpp/storage/file_system.h#L42-L45)):
...
aborted transactions; see `pax.cc:213-224`[(src)](https://github.com/apache/cloudberry/blob/2.1.0-incubating/contrib/pax_storage/src/cpp/storage/pax.cc#L213-L224)).
...
(`micro_partition_iterator.cc:122`[(src)](https://github.com/apache/cloudberry/blob/2.1.0-incubating/contrib/pax_storage/src/cpp/storage/micro_partition_iterator.cc#L122)):
...
(`pax.cc:651-654`[(src)](https://github.com/apache/cloudberry/blob/2.1.0-incubating/contrib/pax_storage/src/cpp/storage/pax.cc#L651-L654)):
...
1. Reads the current visimap (if `ptvisimapname` is not NULL) under the caller's snapshot.
...
(`pax.cc:454-462`[(src)](https://github.com/apache/cloudberry/blob/2.1.0-incubating/contrib/pax_storage/src/cpp/storage/pax.cc#L454-L462))
...
`README.md:32`[(src)](https://github.com/apache/cloudberry/blob/2.1.0-incubating/contrib/pax_storage/doc/README.md#L32)
...
`pax_access_method_internal.cc:86-91`[(src)](https://github.com/apache/cloudberry/blob/2.1.0-incubating/contrib/pax_storage/src/cpp/access/pax_access_method_internal.cc#L86-L91):
...
`pax_table_cluster.cc:58`[(src)](https://github.com/apache/cloudberry/blob/2.1.0-incubating/contrib/pax_storage/src/cpp/access/pax_table_cluster.cc#L58).

### VACUUM FULL / CLUSTER rewrites files

Both go through the `relation_copy_for_cluster` callback
(`pax_access_method_internal.cc:318-345`[(src)](https://github.com/apache/cloudberry/blob/2.1.0-incubating/contrib/pax_storage/src/cpp/access/pax_access_method_internal.cc#L318-L345)),
which calls either:

- `PaxAuxRelationCopyDataForCluster` - copy files to a new relfilenode unchanged.
- `IndexCluster` - read tuples through the visimap filter, sort by a btree index, and write fresh PORC files.
...
(`pax_aux_table.cc:735`[(src)](https://github.com/apache/cloudberry/blob/2.1.0-incubating/contrib/pax_storage/src/cpp/catalog/pax_aux_table.cc#L735))
...
(`pax_access_handle.cc`[(src)](https://github.com/apache/cloudberry/blob/2.1.0-incubating/contrib/pax_storage/src/cpp/access/pax_access_handle.cc)).
...
(`orc_writer.cc:295`[(src)](https://github.com/apache/cloudberry/blob/2.1.0-incubating/contrib/pax_storage/src/cpp/storage/orc/orc_writer.cc#L295))
...
- Data/toast files from aborted transactions (fastsequence advanced but no
  aux row was committed - see `pax.cc:213-224`[(src)](https://github.com/apache/cloudberry/blob/2.1.0-incubating/contrib/pax_storage/src/cpp/storage/pax.cc#L213-L224)).
...
Registered at extension load in `_PG_init`, `pax_access_handle.cc:1203`[(src)](https://github.com/apache/cloudberry/blob/2.1.0-incubating/contrib/pax_storage/src/cpp/access/pax_access_handle.cc#L1203):

```cpp
paxc::RegisterPaxRmgr();
```

`PAX_RMGR_ID = 199` (in the user-reserved range), defined in `paxc_desc.h`[(src)](https://github.com/apache/cloudberry/blob/2.1.0-incubating/contrib/pax_storage/src/cpp/storage/wal/paxc_desc.h).
The rmgr struct provides `rm_redo` / `rm_desc` / `rm_identify` callbacks via `RegisterCustomRmgr`, `paxc_wal.cc:481-497`[(src)](https://github.com/apache/cloudberry/blob/2.1.0-incubating/contrib/pax_storage/src/cpp/storage/wal/paxc_wal.cc#L481-L497).

### Record types

| Record | Site                                                                                                                                          | Payload |
|---|-----------------------------------------------------------------------------------------------------------------------------------------------|---|
| `XLOG_PAX_INSERT` | `paxc_wal.cc:204`[(src)](https://github.com/apache/cloudberry/blob/2.1.0-incubating/contrib/pax_storage/src/cpp/storage/wal/paxc_wal.cc#L204) | RelFileNode + filename + offset + raw bytes |
| `XLOG_PAX_CREATE_DIRECTORY` | `paxc_wal.cc:240`[(src)](https://github.com/apache/cloudberry/blob/2.1.0-incubating/contrib/pax_storage/src/cpp/storage/wal/paxc_wal.cc#L240)       | RelFileNode of the new `_pax/` directory |
| `XLOG_PAX_TRUNCATE` | `paxc_wal.cc:255`[(src)](https://github.com/apache/cloudberry/blob/2.1.0-incubating/contrib/pax_storage/src/cpp/storage/wal/paxc_wal.cc#L255)       | RelFileNode whose `_pax/` is being wiped |
...
`pax.cc:658-669`[(src)](https://github.com/apache/cloudberry/blob/2.1.0-incubating/contrib/pax_storage/src/cpp/storage/pax.cc#L658-L669):
...
`pax_access_handle.cc:1205`[(src)](https://github.com/apache/cloudberry/blob/2.1.0-incubating/contrib/pax_storage/src/cpp/access/pax_access_handle.cc#L1205):
...
`paxc_wrappers.cc:486`[(src)](https://github.com/apache/cloudberry/blob/2.1.0-incubating/contrib/pax_storage/src/cpp/comm/paxc_wrappers.cc#L486),
...
(`local_file_system.cc`[(src)](https://github.com/apache/cloudberry/blob/2.1.0-incubating/contrib/pax_storage/src/cpp/storage/local_file_system.cc))
...
`local_file_system.cc:168-175`[(src)](https://github.com/apache/cloudberry/blob/2.1.0-incubating/contrib/pax_storage/src/cpp/storage/local_file_system.cc#L168-L175):
...
`orc_writer.cc:939-947`[(src)](https://github.com/apache/cloudberry/blob/2.1.0-incubating/contrib/pax_storage/src/cpp/storage/orc/orc_writer.cc#L939-L947).
...
short-circuits at
`paxc_wal.cc:435-440`[(src)](https://github.com/apache/cloudberry/blob/2.1.0-incubating/contrib/pax_storage/src/cpp/storage/wal/paxc_wal.cc#L435-L440):
...
(`paxc_wal.cc:271-374`[(src)](https://github.com/apache/cloudberry/blob/2.1.0-incubating/contrib/pax_storage/src/cpp/storage/wal/paxc_wal.cc#L271-L374)).
...
- Files orphaned by aborted transactions in the backup window are
  ...
  (`pax.cc:213-224`[(src)](https://github.com/apache/cloudberry/blob/2.1.0-incubating/contrib/pax_storage/src/cpp/storage/pax.cc#L213-L224)),
...
| Area | Source |
|---|---|
| Storage format (PORC) | `doc/README.format.md`[(src)](https://github.com/apache/cloudberry/blob/2.1.0-incubating/contrib/pax_storage/doc/README.format.md) |
| Catalog | `doc/README.catalog.md`[(src)](https://github.com/apache/cloudberry/blob/2.1.0-incubating/contrib/pax_storage/doc/README.catalog.md) |
| TOAST | `doc/README.toast.md`[(src)](https://github.com/apache/cloudberry/blob/2.1.0-incubating/contrib/pax_storage/doc/README.toast.md) |
| CTID encoding | `src/cpp/storage/README_CTID_in_pax.md`[(src)](https://github.com/apache/cloudberry/blob/2.1.0-incubating/contrib/pax_storage/src/cpp/storage/README_CTID_in_pax.md) |
| Table access method entry points | `src/cpp/access/pax_access_handle.cc`[(src)](https://github.com/apache/cloudberry/blob/2.1.0-incubating/contrib/pax_storage/src/cpp/access/pax_access_handle.cc) |
| VACUUM / CLUSTER callbacks | `src/cpp/access/pax_access_method_internal.cc`[(src)](https://github.com/apache/cloudberry/blob/2.1.0-incubating/contrib/pax_storage/src/cpp/access/pax_access_method_internal.cc) |
| DELETE implementation | `src/cpp/access/pax_deleter.cc`[(src)](https://github.com/apache/cloudberry/blob/2.1.0-incubating/contrib/pax_storage/src/cpp/access/pax_deleter.cc) |
| Visimap read | `src/cpp/access/pax_visimap.cc`[(src)](https://github.com/apache/cloudberry/blob/2.1.0-incubating/contrib/pax_storage/src/cpp/access/pax_visimap.cc) |
| Visimap write + scan integration | `src/cpp/storage/pax.cc`[(src)](https://github.com/apache/cloudberry/blob/2.1.0-incubating/contrib/pax_storage/src/cpp/storage/pax.cc) |
| Writer | `src/cpp/storage/orc/orc_writer.cc`[(src)](https://github.com/apache/cloudberry/blob/2.1.0-incubating/contrib/pax_storage/src/cpp/storage/orc/orc_writer.cc) |
| Aux-table catalog | `src/cpp/catalog/pax_aux_table.cc`[(src)](https://github.com/apache/cloudberry/blob/2.1.0-incubating/contrib/pax_storage/src/cpp/catalog/pax_aux_table.cc) |
| File-system abstraction | `src/cpp/storage/file_system.h`[(src)](https://github.com/apache/cloudberry/blob/2.1.0-incubating/contrib/pax_storage/src/cpp/storage/file_system.h), [`local_file_system.cc`[(src)](https://github.com/apache/cloudberry/blob/2.1.0-incubating/contrib/pax_storage/src/cpp/storage/local_file_system.cc) |
| Path building | `src/cpp/comm/paxc_wrappers.cc`[(src)](https://github.com/apache/cloudberry/blob/2.1.0-incubating/contrib/pax_storage/src/cpp/comm/paxc_wrappers.cc) |
| Custom WAL rmgr | `src/cpp/storage/wal/paxc_wal.cc`[(src)](https://github.com/apache/cloudberry/blob/2.1.0-incubating/contrib/pax_storage/src/cpp/storage/wal/paxc_wal.cc), [`paxc_desc.h`[(src)](https://github.com/apache/cloudberry/blob/2.1.0-incubating/contrib/pax_storage/src/cpp/storage/wal/paxc_desc.h) |
| Custom storage manager | `src/cpp/storage/paxc_smgr.cc`[(src)](https://github.com/apache/cloudberry/blob/2.1.0-incubating/contrib/pax_storage/src/cpp/storage/paxc_smgr.cc) |
| Extension entry point | `src/cpp/access/pax_access_handle.cc`[(src)](https://github.com/apache/cloudberry/blob/2.1.0-incubating/contrib/pax_storage/src/cpp/access/pax_access_handle.cc) (`_PG_init`) |
