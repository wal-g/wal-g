...
func HandleBackupPush(
	...
	sentinel := StreamSentinelDto{
		...
		BinLogEnd:          binlogEnd,
		BinLogFileName:     xtrabackupInfo.BinlogPos.FileName,
		BinLogFilePosition: xtrabackupInfo.BinlogPos.FilePosition,
		BinLogLastGTID:     xtrabackupInfo.BinlogPos.LastGTID,
