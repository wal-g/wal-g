...
func (_m *MongoMetaProvider) Finalize(backupName string) error {
...
func (_m *MongoMetaProvider) Init(permanent bool) error {
...
func (_m *MongoMetaProvider) Meta() models.BackupMeta {
	ret := _m.Called()
