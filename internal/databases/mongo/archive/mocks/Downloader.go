...
// LastBackupName provides a mock function with given fields: ctx
func (_m *Downloader) LastBackupName(ctx context.Context) (string, error) {
	ret := _m.Called(ctx)

	if len(ret) == 0 {
		panic("no return value specified for LastBackupName")
	}
