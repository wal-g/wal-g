...
func (manager *DeltaFileManager) FlushDeltaFiles(uploader *WalUploader, completedPartFiles map[string]bool) {
...
func (manager *DeltaFileManager) FlushFiles(uploader *WalUploader) {
