...
func TestGetBackups_emptyFolder(t *testing.T) {
	...
	_ = folder.PutObject(t.Context(), "base_123312", &bytes.Buffer{})

	backups, err := internal.GetBackups(t.Context(), folder)
...
func TestGetBackups(t *testing.T) {
	folder := testtools.MakeDefaultInMemoryStorageFolder()
	_ = folder.PutObject(t.Context(), "base_123312", &bytes.Buffer{})
	_ = folder.PutObject(t.Context(), testStreamBackup.BackupName+utility.SentinelSuffix, &bytes.Buffer{})

	backups, _ := internal.GetBackups(t.Context(), folder)
...
func TestGetBackupsAndGarbage_emptyList(t *testing.T) {
	...
	backups, garbage, _ := internal.GetBackupsAndGarbage(t.Context(), folder)
...
func TestGetBackupsAndGarbage(t *testing.T) {
	folder := testtools.MakeDefaultInMemoryStorageFolder()
	_ = folder.PutObject(t.Context(), "base_123312", &bytes.Buffer{})
	_ = folder.PutObject(t.Context(), "base_321/nop", &bytes.Buffer{})
	_ = folder.PutObject(t.Context(), testStreamBackup.BackupName+utility.SentinelSuffix, &bytes.Buffer{})
...
func TestGetBackupTimeSlices_OrderCheck(t *testing.T) {
	folder := testtools.MakeDefaultInMemoryStorageFolder()
	_ = folder.PutObject(t.Context(), testStreamBackup.BackupName+".1"+utility.SentinelSuffix, &bytes.Buffer{})
	_ = folder.PutObject(t.Context(), testStreamBackup.BackupName+".2"+utility.SentinelSuffix, &bytes.Buffer{})
...
func TestGetLastBackupName(t *testing.T) {
	...
	_, _ = folder.PutObject(t.Context(), b1, &bytes.Buffer{}), folder.PutObject(t.Context(), b2, &bytes.Buffer{})
	lastB, _ := internal.GetLatestBackup(t.Context(), folder)
...
func TestDeleteGarbage_emptyFolder(t *testing.T) {
	...
	objects, folders, _ := folder.ListFolder(t.Context())
	assert.Equal(t, 0, len(objects))
	assert.Equal(t, 0, len(folders))

	err := internal.DeleteGarbage(t.Context(), folder, []string{"backup1", "backup2", "backup3"})
...
func TestDeleteGarbage_nonRecursive(t *testing.T) {
	folder := testtools.MakeDefaultInMemoryStorageFolder()
	_ = folder.PutObject(t.Context(), "backup1/file.json", &bytes.Buffer{})
	_ = folder.PutObject(t.Context(), "backup2/file.json", &bytes.Buffer{})

	objects, folders, _ := folder.ListFolder(t.Context())
	assert.Equal(t, 0, len(objects))
	assert.Equal(t, 2, len(folders))

	err := internal.DeleteGarbage(t.Context(), folder, []string{"backup1"})
	assert.Equal(t, nil, err)
...
func TestDeleteGarbage_recursive(t *testing.T) {
	folder := testtools.MakeDefaultInMemoryStorageFolder()
	_ = folder.PutObject(t.Context(), "backup1/folder1/obj1.tar", &bytes.Buffer{})
	_ = folder.PutObject(t.Context(), "backup1/folder2/obj2.zip", &bytes.Buffer{})
	_ = folder.PutObject(t.Context(), "backup1/meta.json", &bytes.Buffer{})
	_ = folder.PutObject(t.Context(), "backup2/meta_b2.json", &bytes.Buffer{})
	_ = folder.PutObject(t.Context(), "backup2/folder1/obj1.tar", &bytes.Buffer{})
	...
	objects, folders, _ = backup2.ListFolder(t.Context())
