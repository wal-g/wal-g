...
unittest:
	...
	go test -mod vendor -v $(TEST_MODIFIER) -tags "$(BUILD_TAGS)" ./storages/azure/
	go test -mod vendor -v $(TEST_MODIFIER) -tags "$(BUILD_TAGS)" ./storages/fs/
	go test -mod vendor -v $(TEST_MODIFIER) -tags "$(BUILD_TAGS)" ./storages/gcs/
	go test -mod vendor -v $(TEST_MODIFIER) -tags "$(BUILD_TAGS)" ./storages/s3/
	go test -mod vendor -v $(TEST_MODIFIER) -tags "$(BUILD_TAGS)" ./storages/storage
	go test -mod vendor -v $(TEST_MODIFIER) -tags "$(BUILD_TAGS)" ./storages/swift/
