...
// Source: pkg/storages/storage/folder.go
...
func (m *MockFolder) PutObjectWithContext(ctx context.Context, name string, content io.Reader) error {
	m.ctrl.T.Helper()
	ret := m.ctrl.Call(m, "PutObjectWithContext", ctx, name, content)
	ret0, _ := ret[0].(error)
	return ret0
}

// PutObjectWithContext indicates an expected call of PutObjectWithContext.
func (mr *MockFolderMockRecorder) PutObjectWithContext(ctx, name, content interface{}) *gomock.Call {
	mr.mock.ctrl.T.Helper()
	return mr.mock.ctrl.RecordCallWithMethodType(mr.mock, "PutObjectWithContext", reflect.TypeOf((*MockFolder)(nil).PutObjectWithContext), ctx, name, content)
}
