...
WAL_PUSH_LOGS="/tmp/logs/wal_push_logs/pg_delete_before_time_find_full_test_logs"
WAL_FETCH_LOGS="/tmp/logs/wal_fetch_logs/pg_delete_before_time_find_full_test_logs"
BACKUP_PUSH_LOGS="/tmp/logs/backup_push_logs/pg_delete_before_time_find_full_test_logs"
BACKUP_FETCH_LOGS="/tmp/logs/backup_fetch_logs/pg_delete_before_time_find_full_test_logs"
...
backup_time=`wal-g --config=${TMP_CONFIG} backup-list | tail -n 1 | cut -f 2 -d " "`
