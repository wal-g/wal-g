...
psql -p 6000 -d db -c "CREATE SCHEMA restore1"
psql -p 6000 -d db -c "CREATE SCHEMA restore2"
psql -p 6000 -d db -c "CREATE SCHEMA partial"
psql -p 6000 -d db -c "CREATE SCHEMA skip"

psql -p 6000 -d db -c "CREATE TABLE restore1.table1 AS SELECT a FROM generate_series(1,$n) AS a;"
psql -p 6000 -d db -c "CREATE TABLE restore1.table2 AS SELECT a FROM generate_series(1,$n) AS a;"
psql -p 6000 -d db -c "CREATE TABLE restore2.table1 AS SELECT a FROM generate_series(1,$n) AS a;"
psql -p 6000 -d db -c "CREATE TABLE restore2.table2 AS SELECT a FROM generate_series(1,$n) AS a;"
...
psql -p 6000 -d db -c "INSERT INTO restore1.table1 SELECT i FROM generate_series(1,$n)i;"
psql -p 6000 -d db -c "INSERT INTO restore1.table2 SELECT i FROM generate_series(1,$n)i;"
psql -p 6000 -d db -c "INSERT INTO restore2.table1 SELECT i FROM generate_series(1,$n)i;"
psql -p 6000 -d db -c "INSERT INTO restore2.table2 SELECT i FROM generate_series(1,$n)i;"
...
if [ "$(psql -p 6000 -t -c "SELECT count(*) FROM restore1.table1;" -d db -A)" != $($n * 2) ]; then
  echo "Error: restore1 namespace must be restored after partial fetch"
  exit 1
elif [ "$(psql -p 6000 -t -c "SELECT count(*) FROM restore1.table2;" -d db -A)" != $($n * 2) ]; then
  echo "Error: restore1 namespace must be restored after partial fetch"
  exit 1
elif [ "$(psql -p 6000 -t -c "SELECT count(*) FROM restore2.table1;" -d db -A)" != $($n * 2) ]; then
  echo "Error: restore2 namespace must be restored after partial fetch"
  exit 1
elif [ "$(psql -p 6000 -t -c "SELECT count(*) FROM restore2.table2;" -d db -A)" != $($n * 2) ]; then
  echo "Error: restore2 namespace must be restored after partial fetch"
  exit 1
